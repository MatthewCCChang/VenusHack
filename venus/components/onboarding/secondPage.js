...
const SecondPage = ({ profileData, handleChange, nextStep, prevStep}) => {
  ...
  const inputFields = [
    ...
    { placeholder: 'Username', value: formData.username, name: 'username', autoCapitalize: 'none' },
    { placeholder: 'Phone', value: formData.phone, name: 'phone', autoCapitalize: 'none' },
    { placeholder: 'Email', value: formData.email, name: 'email', keyboardType: 'email-address', autoCapitalize: 'none' },
    { placeholder: 'Password', value: formData.password, name: 'password', secureTextEntry: true, autoCapitalize: 'none' }
